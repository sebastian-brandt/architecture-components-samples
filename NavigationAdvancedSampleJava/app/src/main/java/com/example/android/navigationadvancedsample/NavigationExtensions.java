...
public final class NavigationExtensions {
            ...
            Intent intent)
    {
        ...
        final Holder<String> selectedItemTag = Holder.of(graphIdToTagMap.get(bottomNavigationView.getSelectedItemId()));
        String firstFragmentTag = graphIdToTagMap.get(firstFragmentGraphId);
        final Holder<Boolean> isOnFirstFragment = Holder.of(equals(selectedItemTag.value, firstFragmentTag));
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            ...
            if (fragmentManager.isStateSaved()) {
                ...
                if (! selectedItemTag.value.equals(newlySelectedItemTag)) {
                    ...
                    selectedItemTag.value = newlySelectedItemTag;
                    isOnFirstFragment.value = equals(selectedItemTag.value, firstFragmentTag);
        ...
        fragmentManager.addOnBackStackChangedListener(() -> {
            if (!isOnFirstFragment.value && !isOnBackStack(fragmentManager, firstFragmentTag)) {
